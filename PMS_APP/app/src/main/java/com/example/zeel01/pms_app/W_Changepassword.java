...
public class W_Changepassword {

    private static String METHOD_NAME = "update_password";
    ...
    public static String changepassword(String id, String op,String np) {
        String str="";
        try {
            SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME);
            request.addProperty("id", id);
            request.addProperty("op",op);
            request.addProperty("np", np);
