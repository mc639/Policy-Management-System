...
public class W_GetPolicyPlan {

    private static String METHOD_NAME = "getpolicy_plan";
    ...
    public static String getpolicyplan(String policy_id) {
        String str="";
        try {
            SoapObject request = new SoapObject(NAMESPACE, METHOD_NAME);
            request.addProperty("id", policy_id);
