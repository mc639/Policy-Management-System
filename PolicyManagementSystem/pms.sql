...
insert  into `policy_plan`(`plan_id`,`policy_id`,`tabular_rate`,`rebet_2_to_5_lac`,`rebet_above_5_lac`,`premium_mode_six_month`,`premium_mode_one_year`,`no_of_years`,`plan_name`) values (1,1,45,1,3,4,5,25,'Anand 1'),(5,2,40,2,2,3,4,17,'Lakhya 1'),(6,3,40,1,3,4,3,30,'Akshay 1');
...
insert  into `user`(`user_id`,`first_name`,`middle_name`,`last_name`,`address`,`city_id`,`phone_no`,`email_id`,`dob`,`photo`,`marital_status`,`sex`,`login_id`,`password`,`anivarsary_date`,`id_proof`,`address_proof`,`office_address`,`user_type`,`premium_pay_mode`,`reg_date`,`bank_name`,`account_number`) values (1,'Mohammed','H','Contractor','Khanpur',1,'99999','mohammedcontractor786@gmail.com','1997-04-17','',1,1,'mammu','mammu','2015-12-03',NULL,NULL,NULL,1,1,'2017-03-01',NULL,NULL),(2,'Zeel','B','Shah','Naranpura',1,'123456789','zeel_b2gmail.com','1996-10-25',NULL,1,2,'zeel','zeel',NULL,NULL,NULL,NULL,1,1,'2017-03-06',NULL,NULL),(3,'Rumaila','R','Saiyed','Kalupur',1,'456358422','rumi_r@yahoo.com','1996-08-27',NULL,1,2,'rummi','rummi',NULL,NULL,NULL,NULL,1,1,'2017-03-06',NULL,NULL);
