...
insert  into `policy`(`policy_id`,`policy_name`,`policy_no`,`sum_insurance`,`surrenderpolicy_amnt_percentage`,`min_age`,`max_age`) values (1,'Jeevan Anand ','101',10000,15,3,18),(2,'Jeevan Lakshya','180',500000,10,18,35),(3,'Jeevan Akshya','107',200000,5,15,45);
...
insert  into `policy_plan`(`plan_id`,`policy_id`,`tabular_rate`,`rebet_2_to_5_lac`,`rebet_above_5_lac`,`premium_mode_six_month`,`premium_mode_one_year`,`no_of_years`,`plan_name`) values (1,1,45,1,3,4,5,25,'Anand 1'),(5,2,40,2,2,3,4,17,'Lakhya 1'),(6,3,40,1,3,4,3,33,'Akshay 1');
...
insert  into `premium`(`premium_id`,`user_policy_id`,`payment_date`,`amount`,`cheque_number`,`payment_mode`) values (1,1,'2017-03-23',10000,NULL,0);
...
CREATE TABLE `user` (
  ...
  `anivarsary_date` date DEFAULT NULL,
...
insert  into `user`(`user_id`,`first_name`,`middle_name`,`last_name`,`address`,`city_id`,`phone_no`,`email_id`,`dob`,`photo`,`marital_status`,`sex`,`login_id`,`password`,`anivarsary_date`,`id_proof`,`address_proof`,`office_address`,`user_type`,`premium_pay_mode`,`reg_date`,`bank_name`,`account_number`) values (1,'Mohammed','H','Contractor','Khanpur',1,'9978813589','mohammedcontractor786@gmail.com','1997-04-17','photo/profile/a.jpg',1,1,'mammu','mammu','2015-12-03',NULL,NULL,NULL,1,1,'2017-03-01',NULL,NULL),(2,'Zeel','B','Shah','Naranpura',1,'123456789','zeel_b2gmail.com','1996-10-25','photo/profile/a.jpg',1,2,'zeel','zeel1',NULL,NULL,NULL,NULL,1,1,'2017-03-06',NULL,NULL),(3,'Rumaila','R','Saiyed','Kalupur',1,'456358422','rumi_r@yahoo.com','1996-08-27','photo/profile/a.jpg',1,2,'rummi','rummi',NULL,NULL,NULL,NULL,1,1,'2017-03-06',NULL,NULL);
...
insert  into `user_policy`(`user_policy_id`,`user_id`,`plan_id`,`policy_purchase_date`,`policy_amnt`,`nominee_name`,`nominee_relation_type`,`premium_type`,`policy_status`) values (1,1,1,'2017-03-18',500000,'Tasneem Contractor','Sister',1,1);
...
CREATE TABLE `wishlist` (
  `wishlist_id` tinyint(3) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NOT NULL,
  `plan_id` tinyint(2) NOT NULL,
...
insert  into `wishlist`(`wishlist_id`,`user_id`,`plan_id`) values (1,1,1);
